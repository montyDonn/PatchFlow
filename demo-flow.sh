...
# 4. Assign managers
echo "Assigning AbhishekRishi as manager for SachinP and Pankaj..."
...
echo "AbhishekRishi moving patch to IN_DEVELOPMENT..."
...
# 10. Login as SachinP (DEVELOPER)
echo "Logging in as SachinP (DEVELOPER)..."
DEV_LOGIN_RES=$(curl -s -X POST http://localhost:8080/api/auth/login \
  -H "Content-Type: application/json" \
  -d '{"username":"sachinp","password":"demo123"}')
...
echo "SachinP moving patch to VERIFYING..."
