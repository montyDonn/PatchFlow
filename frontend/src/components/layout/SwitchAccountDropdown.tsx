...
const ROLE_GROUPS = [
  ...
  { label: 'TESTERS', roles: ['TESTER'] },
  { label: 'VERIFIERS', roles: ['VERIFIER'] },
  { label: 'DEPLOYERS', roles: ['DEPLOYER'] },
...
export function SwitchAccountDropdown() {
  ...
  const defaultAccounts = useMemo(() => [
    ...
    { username: 'tester1', name: 'Tester 1', role: 'TESTER', pwd: 'upcl@123', moduleCount: 1 },
    { username: 'verifier1', name: 'Verifier 1', role: 'VERIFIER', pwd: 'upcl@123', moduleCount: 0 },
    { username: 'deployer1', name: 'Deployer 1', role: 'DEPLOYER', pwd: 'upcl@123', moduleCount: 1 },
